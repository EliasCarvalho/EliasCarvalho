 ...
 * @author equipes
 */
public class CursoPessoaRelatorios extends Window {
    ...
    public void onCreate() {
        ...
        this.setPessoa((Intbox) getFellow("pessoa"));
    }

    // CARGA DOS DADOS INICIAIS PARA O FORMULARIO
    //****************** EVENTOS DE MANUTENÇÃO DOS DADOS NO BANCO DE DADOS ***********************
    public void relatorioPessoaCurso() throws ServletException, FileNotFoundException {
        String arquivoPdf = "";
        ...
        try {
            ...
            parametro.put("pessoa", this.getPessoa().getValue());
            parametro.put("SUBREPORT_DIR", destino);
...
//        Executions.getCurrent().sendRedirect(arquivoPdf, "relatorios");
     ...
     */
    public void setPessoa(Intbox pessoa) {
        this.pessoa = pessoa;
    }
}
