 ...
 * @author equipes
 */
public class InscricaoRelatorios extends Window {
    ...
    private Window winInscricaoRel;
    ...
    public void onCreate() {
        ...
        this.setWinInscricaoRel((Window) getFellow("winInscricaoRel"));

    }

    // CARGA DOS DADOS INICIAIS PARA O FORMULARIO
    //****************** EVENTOS DE MANUTENÇÃO DOS DADOS NO BANCO DE DADOS ***********************
    public void relatorioInscricoesCurso() throws ServletException, FileNotFoundException {
        String arquivoPdf = "";
...
//        Executions.getCurrent().sendRedirect(arquivoPdf, "relatorios");
     ...
     */
    public Window getWinInscricaoRel() {
        return winInscricaoRel;
    }

    /**
     * @param winInscricaoRel the winInscricaoRel to set
     */
    public void setWinInscricaoRel(Window winInscricaoRel) {
        this.winInscricaoRel = winInscricaoRel;
    }
